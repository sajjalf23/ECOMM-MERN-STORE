    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <div className="flex items-center gap-6">
                <img src={assets.search_icon} className='w-5 cursor-pointer' alt="" onClick={()=>{ setshowsearch(!showsearch);  setsearch("");}} />
                ...
                {visible &&
                    <div className={`fixed top-0 right-0 h-full w-64 bg-white shadow-md transition-transform duration-300 ${visible ? "translate-x-0" : "translate-x-full"}`}>
